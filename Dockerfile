...
COPY "./target/ms-programacionfecha-backend-1.0.jar" "app.jar"
EXPOSE 7167
#ADD target/ms-programacionfecha-backend-1.0 ms-programacionfecha-backend-1.0
...
ENTRYPOINT ["java", "-Djava.awt.headless=true", "-Duser.timezone=America/Lima", "-jar","app.jar"]